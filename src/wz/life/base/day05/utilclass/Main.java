package wz.life.base.day05.utilclass;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 由于浮点数计算存在误差，
        // 不同的平台（例如x86和ARM）计算的结果可能不一致（指误差不同），
...
//        有的使用真正的随机数生成器。实际使用的时候，
//        可以优先获取高强度的安全随机数生成器，如果没有提供，
//        再使用普通等级的安全随机数生成器：
...
//        在密码学中，安全的随机数非常重要。如果使用不安全的伪随机数，
//        所有加密体系都将被攻破。因此，时刻牢记必须使用SecureRandom来产生安全的随机数。
